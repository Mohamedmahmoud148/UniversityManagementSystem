...
namespace UniversityManagementSystem.Core.DTOs
{
    ...
    public record CreateDepartmentDto([Required] string Name, [Required] Ulid CollegeId);

    public record BatchDto(Ulid Id, string Name, string Code, Ulid DepartmentId);
    public record CreateBatchDto([Required] string Name, [Required] Ulid DepartmentId);
}
