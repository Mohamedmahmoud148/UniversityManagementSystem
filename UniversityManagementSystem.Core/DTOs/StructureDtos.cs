...
namespace UniversityManagementSystem.Core.DTOs
{
    ...
    public record CollegeDto(int Id, string PublicId, string Name, int UniversityId);
    public record CreateCollegeDto([Required] string Name, [Required] int UniversityId);

    public record DepartmentDto(int Id, string PublicId, string Name, int CollegeId);
